                ...
                <div class="col-12">
                    <div class="row ec_breadcrumb_inner">
                        <div class="col-md-6 col-sm-12">
                            <h2 class="ec-breadcrumb-title">AI Reccomendated Artworks</h2>
                        </div>
                        <div class="col-md-6 col-sm-12">
                            <!-- ec-breadcrumb-list start -->
                            <ul class="ec-breadcrumb-list">
                                <li class="ec-breadcrumb-item"><a href="../">Home</a></li>
                                <li class="ec-breadcrumb-item"><a href="../">Recommendations</a></li>
                                <li class="ec-breadcrumb-item active">Artworks</li>
                            </ul>
                    ...
                    <div class="shop-pro-content">
                        <div class="shop-pro-inner">
                            <div class="row">
                                ...
                                $categories_sql = mysqli_query($mysqli, "SELECT DISTINCT p.product_category_id 
                                FROM orders o
                                INNER JOIN products p ON o.order_product_id = p.product_id
                                WHERE o.order_user_id = '{$_SESSION['user_id']}'");

                                $category_ids = [];
                                while ($row = mysqli_fetch_assoc($categories_sql)) {
                                ...
                                if (!empty($category_ids)) {
                                    ...
                                    // Fetch recommended products based on order history
                                    $recommendation_sql = mysqli_query($mysqli, "SELECT * FROM products p
                                    INNER JOIN categories c ON c.category_id = p.product_category_id
                                    WHERE c.category_delete_status = '0'
                                    AND p.product_delete_status = '0'
                                    AND p.product_category_id IN ($category_ids_str) 
                                    AND p.product_id NOT IN (
                                        SELECT order_product_id FROM orders
                                        WHERE order_user_id = '{$_SESSION['user_id']}'
                                    )
                                    ORDER BY RAND() LIMIT 9");
                                } else {
                                    // No orders? Show random artworks instead
                                    $recommendation_sql = mysqli_query($mysqli, "SELECT * FROM products p
                                    INNER JOIN categories c ON c.category_id = p.product_category_id
                                    WHERE c.category_delete_status = '0'
                                    AND p.product_delete_status = '0'
                                ...
                                if (mysqli_num_rows($recommendation_sql) > 0) {
                                    while ($products = mysqli_fetch_array($recommendation_sql)) {
                                        $image_dir = $products['product_image'] ? "../public/uploads/products/" . $products['product_image'] : "../public/uploads/products/no_image.png";
                                ?>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-6 mb-6 pro-gl-content">
                                        <div class="ec-product-inner">
                                            ...
                                            <div class="ec-pro-content">
                                                <h5 class="ec-pro-title">
                                                    No available artworks for the moment. For the reccomendation AI to work, you need to have at least few artworks in your bid .
                                                </h5>
                                            </div>
                                        </div>
                                    </div>
