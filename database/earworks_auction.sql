...
CREATE TABLE `bids` (
  ...
  `bid_user_id` int(200) NOT NULL,
  `bid_product_id` int(200) NOT NULL,
  `bid_code` varchar(200) NOT NULL,
  `bid_date` varchar(200) NOT NULL,
  `bid_qty` varchar(200) NOT NULL,
  `bid_cost` varchar(200) NOT NULL,
  `bid_status` varchar(200) NOT NULL DEFAULT 'Pending',
  `bid_delete_status` int(5) NOT NULL DEFAULT 0
...
INSERT INTO `bids` (`bid_id`, `bid_user_id`, `bid_product_id`, `bid_code`, `bid_date`, `bid_qty`, `bid_cost`, `bid_status`, `bid_delete_status`) VALUES
(18, 1, 3, 'BID-08032025-VZ8RP', '08 Mar 2025 3:47pm', '1', '4500', 'Approved', 0);
...
INSERT INTO `orders` (`order_id`, `order_user_id`, `order_bid_id`, `order_product_id`, `order_code`, `order_date`, `order_qty`, `order_cost`, `order_status`, `order_payment_status`, `order_delete_status`, `order_estimated_delivery_date`) VALUES
(83, 1, 18, 3, 'ORD-08032025-CSTFB', '2025-03-08 15:50:25', '1', '4500', 'Delivered', 'Paid', 0, '2025-03-08 15:50:25');
...
(34, 'ORD-08032025-1OSZY', 9, '950', '1741436763', '2025-03-08 12:26:47', 0),
(35, 'ORD-08032025-G8I13', 2, '1400', '1741437085', '2025-03-08 12:33:14', 0),
(36, 'ORD-08032025-D5Z29', 9, '5000', '1741437405', '2025-03-08 12:37:27', 0),
(37, 'ORD-08032025-UJLW4', 9, '1000', '1741437512', '2025-03-08 12:39:09', 0),
(38, 'ORD-08032025-CSTFB', 9, '5000', '1741438245', '2025-03-08 12:51:39', 0);
...
(9, 10, 35, 'PRD-17092022-0DKRW', 'Devlan Broken Logo', 'A computer generated art, a 3d design of Devlan solutions logo with broken glass effect. Elegant for showcase in your office or apartment.', '5', '500', 'PRD-17092022-0DKRW-1663392876.jpg', 0, '2022-09-17 09:36am'),
(10, 10, 35, 'PRD-17092022-G6TP5', 'Devlan Peeled Logo', 'Curious about peeled logos handing on your apartment or workspace?. This computer designed artwork has a peeled plaster on wall exposing Devlan Solutions LTD logo.', '3', '4500', 'PRD-17092022-G6TP5-1663393781.jpg', 0, '2022-09-17 09:36am'),
...
(1, 'Flutterwave Rave', 'FLWSECK_TEST-d6261bd386fefc2e6866ee0f859783f1-X', 'FLWSECK_TEST-d6261bd386fefc2e6866ee0f859783f1-X');
...
(8, 'Nancy', 'Ithagi', 'njambiithagi@gmail.com', '2022-02-28', '+12523457895', '54-9865 Manhattan New York', 'a69681bcf334ae130217fea4505fd3c994f5683f', '7627807510fe621c846ec657', 'Confirmed', 'Active', 'Customer_1661408324.jpg', '2022-08-22 15:19:00', 'Administrator', 0, '1BP0TZ', 0),
...
(29, 'Andrew', 'Hamilton', 'jegoxor344@vasqa.com', '1956-01-01', '802-595-9018', '1211 Essex Court, South Burlington, Vermont(VT), 05403', '2a215231238ab859227b54b137dc6799a40fd39c', NULL, 'Pending', 'Active', 'Customer_1661771148.jpg', '2022-08-29 10:14:13', 'Seller', 0, NULL, 0),
...
(38, 'James ', 'Doe', 'Demo@123', '1990-12-12', '254789562361', 'Localhost', '67a74306b06d0c01624fe0d0249a570f4d093747', NULL, 'Pending', 'Pending', 'Staff_1740900330.png', '2025-03-02 07:25:30', 'Staff', 0, NULL, 0),
(39, 'Encrata ', 'Arts', 'Demo@123', '1995-12-12', '254789562025', '120 Localhost', '67a74306b06d0c01624fe0d0249a570f4d093747', NULL, 'Pending', 'Active', 'Customer_1740901042.png', '2025-03-02 07:37:22', 'Seller', 0, NULL, 0),
(40, 'Test', 'test', 'Demo@123', '1995-12-12', '254789456123', 'Localhost', '67a74306b06d0c01624fe0d0249a570f4d093747', NULL, 'Pending', 'Active', 'Customer_1740901963.png', '2025-03-02 07:52:43', 'Customer', 0, NULL, 0),
(41, 'Nancy', 'Ithagi', 'nancyithagi4@gmail.com', '2025-01-05', '0716904886', '5277', '3ed2c19142717a7f6f7aba60c7697f535adb4ebd', NULL, 'Pending', 'Active', NULL, '2025-03-24 17:09:44', 'Customer', 0, NULL, 0);
...
ALTER TABLE `bids`
  ...
  ADD KEY `BidUserID` (`bid_user_id`),
  ADD KEY `BidProductID` (`bid_product_id`);
...
ALTER TABLE `orders`
  ...
  ADD KEY `OrderBidId` (`order_bid_id`);
...
--
ALTER TABLE `bids`
  MODIFY `bid_id` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
...
--
ALTER TABLE `orders`
  MODIFY `order_id` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=84;

--
-- AUTO_INCREMENT for table `payments`
--
ALTER TABLE `payments`
  MODIFY `payment_id` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
...
--
ALTER TABLE `users`
  MODIFY `user_id` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
...
--
ALTER TABLE `bids`
  ADD CONSTRAINT `BidProductID` FOREIGN KEY (`bid_product_id`) REFERENCES `products` (`product_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `BidUserID` FOREIGN KEY (`bid_user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `orders`
  ...
  ADD CONSTRAINT `OrderBidId` FOREIGN KEY (`order_bid_id`) REFERENCES `bids` (`bid_id`) ON DELETE CASCADE ON UPDATE CASCADE;
